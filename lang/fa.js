export default {
  ...
  homePage: {
    ...
    services: {
      ...
      balls: {
        ...
        social_health_description:
          'برخورداری از تعاملات اجتماعی، به اشتراك گذاری تجربیات، احساس تعلق به یك گروه، مشاركت اجتماعی',
    ...
    video: {
      ...
      description: 'برخورداری از تعاملات اجتماعی، به اشتراك گذاری تجربیات، احساس تعلق به یك گروه، مشاركت اجتماعی'
    },
    impact: {
