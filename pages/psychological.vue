<template>
  <div class="d-flex flex-column align-center h-full text-center" style="background-color: #f3911f">
    <h1 class="bel mt-16 f-80 white--text text--darken-3 font-weight-regular">Psychological Health</h1>
    ...
    <v-img class="mt-16" contain src="/images/video_content/psychological.png" />
