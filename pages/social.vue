<template>
  <div class="d-flex flex-column align-center h-full text-center" style="background-color: #a01e64">
    <h1 class="bel mt-16 f-80 white--text text--darken-3 font-weight-regular">Social Health</h1>
